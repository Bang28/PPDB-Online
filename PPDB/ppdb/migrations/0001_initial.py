# Generated by Django 3.2.23 on 2023-12-19 06:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(help_text='foto 3x4 dengan background merah', max_length=255, upload_to=ppdb.models.Peserta.image_upload_to, verbose_name='Foto Peserta')),
                ...
                ('thn_ajaran', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ppdb.periodeppdb', verbose_name='Tahun Ajaran')),
            ],
            options={
